...
(* TODO: factor out so I can apply tactics to r_rewr_bi (this will simplify proofs a ton) *)
...
| rewr_ext : forall rs n G c b (k k' : Reaction G c),
  ...
  | rewr_str : forall (rs : rlist) pos (g : seq (N * T)) (f : N * T) (d : Reaction g f) b (n : N * T) rs,
